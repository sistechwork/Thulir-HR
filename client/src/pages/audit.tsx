...
import type { Lead, LeadHistory, User as UserType } from "@shared/schema";

type LeadHistoryWithUser = LeadHistory & {
  changedBy?: UserType;
};
...
export default function Audit() {
  ...
  const { data: leadHistory } = useQuery<LeadHistoryWithUser[]>({
